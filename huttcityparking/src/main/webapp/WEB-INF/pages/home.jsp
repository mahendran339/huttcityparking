...
$(document).ready(function() {
    ...
    $('#register_submit').click(function() {
    	 $('#register_form').validate({ // initialize plugin
    	        // rules & options, 
    	        rules: {
    	        	firstname: {
    	                required: true,
...
<h3 align="center">Hutt City parking services</h3>
    	<div class="row">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register_form" action="register" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<input type="password" name="confirm_password" id="confirm_password" tabindex="6" class="form-control" placeholder="Confirm Password">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit"  id="register_submit" tabindex="7" class="form-control btn btn-register" value="Register Now">
											</div>
										</div>
									</div>
								</form>
	...
	<p align="center">Welcome to hutt city parking services online. It is proudly owned by Hutt city council. <br>The parking duration is limited to 120 minutes except emergency cases. </p>
</body>
</html>
